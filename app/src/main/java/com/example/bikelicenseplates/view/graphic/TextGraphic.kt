 ...
 * overlay view.
 */
class TextGraphic constructor(overlay: GraphicOverlay, private val text: Text, private val objectRect: Rect) :
    ...
    override fun draw(canvas: Canvas) {
        ...
        for (textBlock in text.textBlocks) { // Renders the text at the bottom of the box.
            ...
            for (line in textBlock.lines) {
                ...
                rect.offset(objectRect.left.toFloat(), objectRect.top.toFloat())
